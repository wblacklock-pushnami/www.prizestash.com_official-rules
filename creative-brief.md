# Creative Brief — Official Sweepstakes Rules

**Source URL (recreate to the letter, then clean it up):** [https://www.prizestash.com/official-rules](https://www.prizestash.com/official-rules)
**Notes from tracker:** Legal Page
**Folder:** `pages/www.prizestash.com_official-rules/`
...
Long-form sweepstakes legal terms — eligibility, entry, prize, odds, winner selection, disclaimers.

This page is a **like-for-like recreation** of `https://www.prizestash.com/official-rules` — every clause, field, headline, and link from the live page must appear in the rebuild. Pull the exact body copy and structure from the live page, then re-skin it using the design system below. Do not paraphrase legal text; copy it verbatim.

## 2. Content sections (in order)

1. Header — title 'Official Rules', sweepstakes name, dates of entry period
2. Sticky in-page TOC
3. 1 — No purchase necessary
4. 2 — Eligibility
5. 3 — Sponsor & administrator
6. 4 — Entry period & how to enter
7. 5 — Prize description & ARV
8. 6 — Odds of winning
9. 7 — Winner selection & notification
10. 8 — Verification of potential winner
11. 9 — Publicity release
12. 10 — General conditions & release of liability
13. 11 — Disputes & governing law
14. 12 — Privacy
15. 13 — Winners list — link to suppression-list-download or winners page

> **Sourcing note:** open `https://www.prizestash.com/official-rules` and copy the actual text into the matching section above. If a section on the live page is missing here, add it; if a section here doesn't exist on the live page, drop it. Goal is exact content parity, cleaner presentation.

## 3. Layout

720px column, sticky TOC on desktop. 'No Purchase Necessary' banner pinned below the page header in `--purple-tint`.

## 4. Calls to action

Inline link to the winners list / suppression-list-download page.
...
- [ ] Every piece of copy from `https://www.prizestash.com/official-rules` is present in `index.html` (verbatim for legal sections).
